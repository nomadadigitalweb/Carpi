...
// Global styles are in root layout or here? Usually root imports globals.css
        ...
        <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black">
            <header className="fixed top-0 left-0 right-0 z-50 grid grid-cols-3 items-center px-8 py-6 bg-black/95 backdrop-blur-sm transition-all duration-300">
                ...
                <div className="flex items-center justify-end gap-6">
                    <Link href="/tienda" className="text-[10px] font-bold uppercase tracking-[0.25em] text-white hover:text-gray-400 transition-colors">Tienda</Link>
                    <Link
                        href="/login"
                        className="text-[10px] font-bold uppercase tracking-[0.3em] text-white hover:text-gray-300 transition-colors border border-white/20 px-6 py-3 hover:bg-white hover:text-black"
                    >
                        INGRESAR
                    </Link>
                </div>
