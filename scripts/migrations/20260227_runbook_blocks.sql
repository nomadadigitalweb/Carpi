-- Carpi SQL Runbook (Copy/Paste por bloques)
-- Fecha: 2026-02-27
-- Uso recomendado en Supabase SQL Editor:
--   1) Ejecutar BLOQUE 1 (PRE-CHECKS)
--   2) Ejecutar BLOQUE 2 (MIGRACIÓN)
--   3) Ejecutar BLOQUE 3 (POST-CHECKS)
...
-- 3) Legacy role distribution
SELECT role, COUNT(*)
FROM public.profiles
GROUP BY role
ORDER BY COUNT(*) DESC;

-- 4) Orders linked by legacy email
SELECT
  COUNT(*) FILTER (
